...
parser.add_argument('--checkpoint_path', type=str, default='./checkpoints/epoch_35.pth',
...
parser.add_argument('--num_classes', type=int, default=14, help='num of object classes')
