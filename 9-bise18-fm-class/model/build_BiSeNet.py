...
class FeatureFusionModule(torch.nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        # 18_s
        self.in_channels = 256  # 64 + (64 + 128)
        # 18/34
...
class BiSeNet(torch.nn.Module):
    def __init__(self, num_classes, context_path, phase_train=False):
        ...
        # 18_s
        self.attention_refinement_module1 = AttentionRefinementModule(64, 64, phase_train=phase_train)  # in = out
        self.attention_refinement_module2 = AttentionRefinementModule(128, 128, phase_train=phase_train)
        # 34/18
        ...
        self.phase_train = phase_train
        # 18_s
        self.cx1_mid_supervision_module = MidSupervisionModule(in_channels=64, num_classes=num_classes)
        self.cx2_mid_supervision_module = MidSupervisionModule(in_channels=128, num_classes=num_classes)
        # 34/18
