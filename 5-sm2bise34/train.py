...
med_frq = [0.382900, 0.452448, 0.637584, 0.377464, 0.585595,
           0.479574, 0.381544, 0.982534, 1.017466, 0.624581,  # lower table weight
...
def main(params):
    ...
    parser.add_argument('--data', type=str, default='/home/disk1/xs/sun', help='path of training data')
...
if __name__ == '__main__':
    params = [
        ...
        # '--pretrained_model_path', './checkpoints/epoch_100.pth'
    ]
    main(params)
