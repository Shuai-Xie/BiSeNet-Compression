...
parser.add_argument('--checkpoint_path', type=str, default='./checkpoints/epoch_80.pth',
...
parser.add_argument('--csv_path', type=str, default='/temp_disk/xs/sun/seg37_class_dict.csv', help='Path to label info csv file')
