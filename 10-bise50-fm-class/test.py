...
parser.add_argument('--checkpoint_path', type=str, default='./checkpoints/epoch_95.pth',
                    help='The path to the pretrained weights of model')
parser.add_argument('--context_path', type=str, default="resnet50_s", help='The context path model you are using.')
